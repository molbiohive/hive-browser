...
_FORBIDDEN_PREFIXES = ("hive.db", "hive.server", "hive.tools", "hive.llm", "hive.config")
# Allowed internal imports
_ALLOWED_PREFIXES = ("hive.sdk",)
...
def _load_tool_from_file(py_file: Path, source: str) -> Tool | None:
    ...
    module_name = f"hive_ext_tools.{py_file.stem}"
